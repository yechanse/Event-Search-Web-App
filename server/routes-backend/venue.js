...
router.get('/', async (req, res) => {
    ...
    axios.get(`https://app.ticketmaster.com/discovery/v2/venues?apikey=myAPIkey&&keyword=${venueName}`)
    .then(function (response) {
      ...
      for (let i = 0; i < venues.length; i++) {
        ...
        const phoneNumber = venue.boxOfficeInfo ? venue.boxOfficeInfo.phoneNumberDetail : '';
