...
router.get('/', async (req, res) => {
    ...
    try{
        const response = await axios.get(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=myapikey&keyword=${keyword}&segmentId=${segmentIDdict[category]}&radius=${distance}&unit=miles&geoPoint=${geoResult}`);
